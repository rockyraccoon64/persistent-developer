...
import rr64.developer.infrastructure.task.query.LimitOffsetQueryFactoryTestFacade
...
class TaskSlickRepositoryTestSuite
  ...
  private val queryFactory = LimitOffsetQueryFactoryTestFacade.createFactory(defaultLimit = 20, maxLimit = 100)
